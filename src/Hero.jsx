...
function Hero() {
  ...
  return (
    <main className="grid lg:grid-cols-3  grid-row-[534px] lg:gap-0 gap-[3rem] lg:h-[80%]  font-league-spartan">
      <div
        className={`lg:col-span-2  bg-cover bg-top-left lg:bg-center bg-no-repeat ${image} w-full h-[360px] lg:h-full flex`}
      >
        <div className="flex items-start lg:items-center gap-[7rem] lg:gap-[3rem] py-[2.4rem] lg:py-[2rem] px-[1.3rem] lg:px-[4rem] lg:h-[30px] w-full">
          <img src="public/icon-hamburger.svg" className="flex  lg:hidden" />
          <img
            src="/logo.svg"
